...
function evinBookSetUpDemo(evinBookSetUpDemo) {
    ...
    admin.secret = '$2y$11$rvQnj4Tyw7RLrsyfF6gkz.IYilC0o4hbhvjzajMNjOraKiJ1uMYSa';
    admin.createdAt = dt;
    ...
    publisher.avatar = '/images/P-001_avatar_1594411487jpg';
    publisher.secret = '$2y$11$1eyrh4wTKzEDAhhvxVqjIOw0LuegGON8RKesFv3oMe.Xp9i6iSLJm';
    ...
    publisher2.avatar = '/images/P-001_avatar_1594411487jpg';
    publisher2.secret = '$2y$11$bq9Tl0KaKOn2zYIPf8LHYuHSjOBNe.sdCNq6IxLWrqmYR2OGstlLS';
    ...
    distributor.avatar = '/images/D-001_avatar_1594411295jpg';
    distributor.secret = '$2y$11$zaQSC80FT.C1yTnNf26XBeLtYu4uAjCqys0cx/zNCl8k9/231S49G';
    ...
    individual.avatar = '/images/C-002_avatar_1594411186jpg';
    individual.secret = '$2y$11$MiDEscuxxng6srXz5oTQEeEHlFDFstq9NQfClPskcOIDJkHudDSuK';
    individual.createdAt = dt;
    individual.accountBalance = 1000;
    ...
    retailer.avatar = '/images/C-6a3Gm_avatar_1594411013jpg';
    retailer.secret = '$2y$11$S2km385NKHlsLcZAd/ohsOPVlLsZczjLh0segNINbY1vWy6aZdPb2';
    retailer.createdAt = dt;
    retailer.accountBalance = 10000;
    ...
    return getParticipantRegistry(NS + '.Publisher')
        ...
        .then(function(individualRegistry) {
            return individualRegistry.addAll([individual, retailer]);
        })
        .then(function() {
...
/**
 *  Update the IsConfirmed flag in report to ascertain its legitimacy 
 *  @param{org.evin.book.track.updateReportIsConfirmed} updateReportIsConfirmed
 *  @transaction
 */
async function updateReportIsConfirmed(updateReportIsConfirmed){
    // var customerReportedBy = updateReportIsConfirmed.report.reportedBy;

    let reportAssetRegistry = await getAssetRegistry('org.evin.book.track.Report');

    updateReportIsConfirmed.report.isConfirmed = updateReportIsConfirmed.isConfirmed;
    updateReportIsConfirmed.report.updatedAt = updateReportIsConfirmed.updatedAt;
    await reportAssetRegistry.update(updateReportIsConfirmed.report);
}
...
async function updatePurchaseRequestStatus(updatePurchaseRequestStatus){
    ...
    updatePurchaseRequestStatus.purchaseRequest.updatedAt = updatePurchaseRequestStatus.updatedAt;
...
async function updateBookSold(updateBookSold){
    ...
    updateBookSold.book.updatedAt = updateBookSold.updatedAt;
...
async function updateBookShipment(updateBookShipment){
    ...
    updateBookShipment.book.updatedAt = updateBookShipment.updatedAt;
...
async function updateOrderStatus(updateOrderStatus){
    ...
    updateOrderStatus.order.updatedAt = updateOrderStatus.updatedAt;
...
async function updateShipmentStatus(updateShipmentStatus){
    ...
    updateShipmentStatus.shipment.updatedAt = updateShipmentStatus.updatedAt;
    await shipmentAssetRegistry.update(updateShipmentStatus.shipment);
}

/**
 *  Update the Shipment Item in Shipment Asset
...
async function updateShipmentItemStatus(updateShipmentItemStatus){
    ...
    updateShipmentItemStatus.shipment.updatedAt = updateShipmentItemStatus.updatedAt;
...
async function updateCustomerPoints(updateCustomerPoints){
    ...
    updateCustomerPoints.customer.updatedAt = updateCustomerPoints.updatedAt;
    await customerParticipantRegistry.update(updateCustomerPoints.customer);
}

/**
 *  Update publisher points
 *  @param{org.evin.book.track.updatePublisherPoints} updatePublisherPoints
 *  @transaction
 */
async function updatePublisherPoints(updatePublisherPoints){
    let publisherParticipantRegistry = await getParticipantRegistry('org.evin.book.track.Publisher');

    updatePublisherPoints.publisher.accountBalance = updatePublisherPoints.accountBalance;
    updatePublisherPoints.publisher.updatedAt = updatePublisherPoints.updatedAt;
    await publisherParticipantRegistry.update(updatePublisherPoints.publisher);
}
