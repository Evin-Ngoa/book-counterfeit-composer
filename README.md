...
> composer archive create --sourceType dir --sourceName . -a book-counterfeit-composer@0.3.30.bna
...
> composer network install --card PeerAdmin@hlfv1 --archiveFile book-counterfeit-composer@0.3.30.bna

start our business network 
> composer network start --networkName book-counterfeit-composer --networkVersion 0.3.30 --networkAdmin admin --networkAdminEnrollSecret adminpw --card PeerAdmin@hlfv1 --file networkadmin.card

If started before upgrade version version above 0.0.1 [upgrade]
> composer network upgrade -c PeerAdmin@hlfv1 -n book-counterfeit-composer -V 0.3.30
